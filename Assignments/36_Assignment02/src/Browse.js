  ...
  return !isActive ? (
    ...
    <div className="grid grid-cols-12 bg-gray-300">
      <div className="col-span-1 p-4">
        ...
        <h3 className="text-black text-xl">By Osaid Samman and Devin Alamsya</h3>
      </div>
          ...
          {filtered.map((product) => (
            <div key={product.id}>
              ...
              <div className="mt-4 flex justify-between">
                ...
                <p className="text-sm font-medium text-white whitespace-pre">
              ...
              <div className="flex items-center justify-center">
                ...
                <button
                  ...
                  className="bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 border border-blue-700 rounded"
                >
                  +
                </button>
              </div>
      ...
      <div className="col-span-2 p-4 ">
        ...
        <button
          ...
          className="bg-gray-400 hover:bg-gray-700 py-4 px-4 border-gray-700 rounded"
        >
          🛒
        </button>
      </div>
